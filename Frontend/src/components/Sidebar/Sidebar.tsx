    ...
    <div className="flex ">
      ...
      <div className="w-64 h-screen fixed overflow-y-auto bg-[#212529] flex flex-col gap-8 items-center ">
        <div className="fixed z-500 bg-[#212529] py-3 text-[#32b9a9] flex gap-1 items-center">
          ...
          <span className="font-serif font-semibold text-3xl">Pulse</span>
        </div>
            ...
            {links.map((link) => {
              return (
                <NavLink
                  ...
                  key={link.url}
                  className={({ isActive }) =>
                    `flex items-center gap-3 w-full font-medium text-[#F0F3FB] px-4 py-5 rounded-lg ${
                      isActive
                        ? "bg-[#32b9a9] text-gray-900"
                        : "hover:bg-gray-100 hover:text-[#212529]"
                    }`
                  }
                >
                  {link.icon}
